...
namespace APIRestV2.Controllers
{
    ...
    [ApiController]
    public class PiezaClienteClienteController : ControllerBase
    {
       ...
       // private ValidaDatosRequest _validaReq = new();
        ...
        public PiezaClienteClienteController(IConfiguration configuration)
        {
        ...
        public ActionResult<VwPiezaCliente> Find(long idPieza) 
        {
            try
            {
                ...
                {
                    var result = process.findPiezaPorIdPieza(idPieza);
                    if (result != null)
                    {
                        return Ok(result);
                    }
