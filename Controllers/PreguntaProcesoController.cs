...
namespace APIRestV2.Controllers
{
    ...
    public class PreguntaProcesoController : ControllerBase
    {
        ...
        [HttpGet("FindPreguntaProcesoMaquinaProceso/{Proceso}")]
        public ActionResult<List<RequestPreguntaProceso>> FindPreguntaProceso(long Proceso)
        {
            try
            {
                ...
                {
                    var result = process.FindPreguntaProcesoByMaquinaProceso(Proceso);
                    return Ok(result);
        ...
        [HttpGet("FindGlobalProcesoIdMaquinaIdNivelCertifica/{IdProceso}/{IdMaquina}/{IdNivelCertifica}/{IdIdioma}")]
        public ActionResult<List<ResponsePreguntasTotalesProcesos>> FindGlobalPreguntasIdMaquinaIdNivelCertifica(long IdProceso, string IdMaquina, long IdNivelCertifica, long IdIdioma)
        {
            try
            {
                ...
                {
                    var result = process.FindGlobalPreguntasIdMaquinaIdNivelCertifica(IdProceso, IdMaquina, IdNivelCertifica, IdIdioma);
                    if (result != null)
                    {
                        return Ok(result);
                    }
