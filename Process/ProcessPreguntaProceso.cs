    ...
    public class ProcessPreguntaProceso
    {
        ...
        public ResponseGral AddPreguntaProceso(RequestPreguntaProceso PreguntaProceso, String ip)
        {
            ...
            try
            {
                ...
                logNewRegistro.ProcesoIdProceso = PreguntaProceso.ProcesoIdProceso;
        ...
        public List <PreguntaProceso> FindPreguntaProcesoByProceso(long id)
        {
            List<PreguntaProceso> respPreguntaProcesoRet = entityData.findPreguntaProcesoIdProceso(id);
